...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ry8oZGl_.mjs");
...
var manifest = {
	"0122ba6d2a99b0277b63d4e9aa94e34734217a037a4fb5cf12bc9502237b7b84": {
		functionName: "getHubSnapshot_createServerFn_handler",
		importer: () => import("./api-CxOfEsI3.mjs")
	},
	"903d8e95b9c166a9ef0cfd73fcd867f6002dbb3ca4c8d41984b8c7a76275472d": {
		functionName: "invokeHub_createServerFn_handler",
		importer: () => import("./api-CxOfEsI3.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cx-wcBGX.mjs").then((n) => n.t),
